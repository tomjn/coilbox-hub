...
export function ItemPreview({
   ...
   *  `lib/gallery/itemPictures.ts`. A blueprint's plan draws an absent def as
   *  its footprint, and a project's changelog leaves the square empty. */
  units?: ReadonlyMap<string, ServedAsset>;
  ...
  if (kind === "mod-project") {
    return <ProjectChanges payload={record} units={units} names={names} />;
  }
  if (kind === "blueprint") {
