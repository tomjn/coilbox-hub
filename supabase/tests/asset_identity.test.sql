...
select lives_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'armsolar', 'buildpic', 'src-a', 'enc-a', 'buildpic-lossless', 'unit/bar/armsolar/buildpic/enc-a.webp', 'extracted', 'image/webp', 900, 128, 128, 'byar-1.2.3.sdd')$$,
...
select lives_ok(
  $$insert into public.asset (map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, map_height, source_archive)
    values ('Comet Catcher Remake 1.8', 'minimap', 'src-m', 'enc-m', 'minimap-q80', 'map/comet/minimap/enc-m.webp', 'extracted', 'image/webp', 40000, 512, 512, 8192, 8192, 'comet_catcher_remake_1.8.sd7')$$,
...
select throws_ok(
  $$insert into public.asset (game, unit_name, map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, map_height, source_archive)
    values ('bar', 'armsolar', 'Comet Catcher Remake 1.8', 'buildpic', 'src-b', 'enc-b', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 8192, 8192, 'a.sdd')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('buildpic', 'src-c', 'enc-c', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 'a.sdd')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', '   ', 'buildpic', 'src-d', 'enc-d', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 'a.sdd')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('armsolar', 'buildpic', 'src-e', 'enc-e', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 'a.sdd')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'armsolar', 'buildpic', 'src-g', 'enc-g', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 'byar-1.2.4.sdd')$$,
  '23505',
  null,
...
select lives_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('xta', 'armsolar', 'buildpic', 'src-h', 'enc-h', 'buildpic-lossless', 'unit/xta/armsolar/buildpic/enc-h.webp', 'extracted', 'image/webp', 900, 128, 128, 'xta.sdz')$$,
  'the same unit name in another game is a different asset'
);

select lives_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'armsolar', 'render:315', 'src-i', 'enc-i', 'render-q80', 'unit/bar/armsolar/render-315/enc-i.webp', 'rendered', 'image/webp', 2000, 256, 192, 'byar-1.2.3.sdd')$$,
  'a render of a unit that already has a buildpic is a different variant'
);

select throws_ok(
  $$insert into public.asset (map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, map_height, source_archive)
    values ('Comet Catcher Remake 1.8', 'minimap', 'src-j', 'enc-j', 'minimap-q80', 'p', 'extracted', 'image/webp', 40000, 512, 512, 8192, 8192, 'a.sd7')$$,
  '23505',
  null,
...
select lives_ok(
  $$insert into public.asset (map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, map_height, source_archive)
    values ('Comet Catcher Remake 1.9', 'minimap', 'src-k', 'enc-k', 'minimap-q80', 'map/comet19/minimap/enc-k.webp', 'extracted', 'image/webp', 40000, 512, 512, 8192, 8192, 'comet_catcher_remake_1.9.sd7')$$,
...
select throws_ok(
  $$insert into public.asset (map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, source_archive)
    values ('Tangerine 1.1', 'minimap', 'src-n', 'enc-n', 'minimap-q80', 'p', 'extracted', 'image/webp', 40000, 512, 512, 8192, 'a.sd7')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (map_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('Tangerine 1.1', 'minimap', 'src-o', 'enc-o', 'minimap-q80', 'p', 'extracted', 'image/webp', 40000, 512, 512, 'a.sd7')$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, map_width, map_height, source_archive)
    values ('bar', 'armpw', 'buildpic', 'src-p', 'enc-p', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 8192, 8192, 'a.sdd')$$,
  '23514',
  null,
...
select lives_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'armpw', 'render:0', 'src-q', 'enc-q', 'render-q80', 'unit/bar/armpw/render-0/enc-q.webp', 'rendered', 'image/webp', 2000, 256, 256, 'a.sdd')$$,
  'a render at any angle is accepted'
);

select throws_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'armpw', 'buildpick', 'src-r', 'enc-r', 'buildpic-lossless', 'p', 'extracted', 'image/webp', 900, 128, 128, 'a.sdd')$$,
  '23514',
  null,
...
select lives_ok(
  $$insert into public.asset (game, unit_name, variant, source_hash, hash, encode_profile, path, origin, mime, bytes, width, height, source_archive)
    values ('bar', 'corsolar', 'buildpic', 'src-a', 'enc-a', 'buildpic-lossless', 'unit/bar/corsolar/buildpic/enc-a.webp', 'extracted', 'image/webp', 900, 128, 128, 'byar-1.2.3.sdd')$$,
